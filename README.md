...
**«Обработка естественного языка»** от АНО ДПО «Образовательные технологии
Яндекса» (Яндекс Практикум), 130 часов, 2025–2026.

> **Статус:** репозиторий формируется. Проекты переносятся из закрытого учебного репозитория курса с очисткой от служебных материалов Практикума и добавлением подробных README по каждому проекту.
...
Курс пройден, выдано удостоверение № 2026-16680-001 от 22.02.2026.
